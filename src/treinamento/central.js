            ...
            <div className="login-header-action ml-auto">
              ...
              <div className="dropdown">
                ...
                <ul className="dropdown-menu">
                  <li>
                    <a className href="#">
                      <i className="icofont-user" /> Profile
                    </a>
                  </li>
                  <li>
                    <a className href="#">
                  ...
                  <li>
                    <a className href="#">
                      <i className="icofont-logout" /> Sign Out
                    </a>
                  </li>
                </ul>
              </div>
          ...
          <div className="page-content-wrapper">
            <div className="container-fluid custom-container">
                  ...
                  <div className="tab-pane fade show active" id="tab1">
                    ...
                    <div className="courses-item">
                      ...
                      <div className="content-wrapper">
                        ...
                        <div className="courses-select">
                          <select>
                            <option data-display="This Month">
                              This Month
                            </option>
              ...
              <div className="courses-resources">
                <h4 className="title">
                  Here are our most popular instructor resources.
                </h4>
                    ...
                    <div className="col">
                      ...
                      <div className="single-resources">
                        <div className="resources-icon">
                          <a href="#">
                            <img
                              src="assets/images/resources-icon/icon-1-1.png"
                              alt="Icon"
                            />
                            <img
                              className="hover"
                              src="assets/images/resources-icon/icon-2-1.png"
                              alt="Icon"
                            />
                          </a>
                        </div>
                    ...
                    <div className="col">
                      ...
                      <div className="single-resources">
                        <div className="resources-icon">
                          <a href="#">
                            <img
                              src="assets/images/resources-icon/icon-1-2.png"
                              alt="Icon"
                            />
                            <img
                              className="hover"
                              src="assets/images/resources-icon/icon-2-2.png"
                              alt="Icon"
                            />
                          </a>
                        </div>
                    ...
                    <div className="col">
                      ...
                      <div className="single-resources">
                        <div className="resources-icon">
                          <a href="#">
                            <img
                              src="assets/images/resources-icon/icon-1-3.png"
                              alt="Icon"
                            />
                            <img
                              className="hover"
                              src="assets/images/resources-icon/icon-2-3.png"
                              alt="Icon"
                            />
                          </a>
                        </div>
                    ...
                    <div className="col">
                      ...
                      <div className="single-resources">
                        <div className="resources-icon">
                          <a href="#">
                            <img
                              src="assets/images/resources-icon/icon-1-4.png"
                              alt="Icon"
                            />
                            <img
                              className="hover"
                              src="assets/images/resources-icon/icon-2-4.png"
                              alt="Icon"
                            />
                          </a>
                        </div>
                        <h5 className="title">
                          <a href="#">Insight Courses</a>
                        </h5>
                      </div>
                      {/* Single Resources Start */}
                    </div>
                    <div className="col">
                      ...
                      <div className="single-resources">
                        <div className="resources-icon">
                          <a href="#">
                            <img
                              src="assets/images/resources-icon/icon-1-5.png"
                              alt="Icon"
                            />
                            <img
                              className="hover"
                              src="assets/images/resources-icon/icon-2-5.png"
                              alt="Icon"
                            />
                          </a>
                        </div>
                    ...
                    <div className="col">
                      ...
                      <div className="single-resources">
                        <div className="resources-icon">
                          <a href="#">
                            <img
                              src="assets/images/resources-icon/icon-1-6.png"
                              alt="Icon"
                            />
                            <img
                              className="hover"
                              src="assets/images/resources-icon/icon-2-6.png"
                              alt="Icon"
                            />
                          </a>
                        </div>
