...
export default function DashadminUsuarios() {
  ...
  const columns = [
    ...
    {
      name: 'Empresa',
      selector: 'idempresa.nome'
  },
];

async function loadUsuarios() {
  setLoading(true);
  const query = '/treinamentos/usuarios';
        ...
        <div className="section overflow-hidden position-relative" id="wrapper">
          ...
          {loading && 
            ...
            <div className="container-fluid custom-container">
              ...
              <div class="tab-btn">
                    <a href="/usuarioNovo" class="btn btn-primary btn-hover-dark">Novo Usuário</a>
                </div>
