...
export default function AdminEditarEmpresa() {
  ...
  async function loadProd() {
    ...
    const response = await api.get('/treinamentos/empresa/'+param[4]);
  ...
  async function handleSubmit(event) {
    ...
    await api
      .post("/treinamentos/empresa/", dataobj)
      .then((res) => {
        ...
        >
          ...
          <div className="container-fluid custom-container">
            ...
            <div className="admin-courses-tab">
              <h3 className="title">Editar Empresa</h3>
            </div>
            <button
